window.onload = function(){
	...
	// animated scene
		...
		function drawForeground() {
			...
			// drawShape(convertClippath(100, 200, "54% 19%,69% 23%,79% 40%,79% 59%, 78.5% 62%, 71% 77%, 70% 80%,69% 84%,67% 87%,64% 88.5%,62% 88.8%,61% 89%,56% 88%, 50% 83%, 44% 88%,39% 89%,38% 88.8%,36% 88.5%,33% 87%,31% 84%,30% 80%,29% 77%, 21.5% 62%,21% 59%,21% 40%,31% 23%,46% 19%"),
			// 	"brown", 10, "brown")
		}
